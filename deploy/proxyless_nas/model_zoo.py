...
proxyless_mobile_05 = partial(
    proxyless_base,
    net_config="https://hanlab.mit.edu/files/proxylessNAS/proxyless_mobile_05.config",
    net_weight="https://hanlab.mit.edu/files/proxylessNAS/proxyless_mobile_05.pth")
